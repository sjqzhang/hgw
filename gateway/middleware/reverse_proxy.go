...
func (p *ReverseProxy) defaultSuccessHandler(rw http.ResponseWriter, req *http.Request) {
}

func (p *ReverseProxy) getSuccessHandler() func(http.ResponseWriter, *http.Request) {
	if p.SuccessHandler != nil {
		return p.SuccessHandler
	}
	return p.defaultSuccessHandler
}
